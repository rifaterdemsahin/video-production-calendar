...
MENU = [
    ...
    ("   ├─ 🛠️ Tools Overview", "2_Environment/tools.md"),
    ...
    ("   ├─ 🖥️ Local Server", "2_Environment/local_server.md"),
    ...
    ("   ├─ 🏛️ TOGAF Gap Analysis", "4_Formula/togaf_gap_analysis.md"),
    ("💎 5. Symbols", "5_Symbols/README.md"),
    ("   ├─ ⚙️ Agent Operating Rules", "5_Symbols/rules/agent_operating_rules.md"),
