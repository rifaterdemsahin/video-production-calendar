...
jobs:
  smoke:
    ...
    steps:
      ...
      - name: Link checker
        run: npx linkinator https://rifaterdemsahin.github.io/video-production-calendar/ --recurse
```
...
2. **Link the issue** in `6_Semblance/error.log`:
   ...
   GitHub Issue: https://github.com/rifaterdemsahin/video-production-calendar/issues/<num>
   ```
