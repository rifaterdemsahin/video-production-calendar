...
description: Bootstrap a new project from video-production-calendar — replace placeholders, reset stage content, rebuild navigation, validate, and deploy. Use when starting a new project from this template or when asked to adapt the template for a consumer project.
---
