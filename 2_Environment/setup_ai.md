...
Kilo Code has built-in nomic text indexing for semantic search. It runs locally without any external service and is the **recommended default** when using the video-production-calendar for smaller projects.
