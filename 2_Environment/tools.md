...
- **Kilo Code Local Nomic Text Indexing (default for small projects):** Built-in, zero-setup semantic search using nomic text indexing. The recommended default when using the video-production-calendar for smaller repos. No Docker, no external services.
