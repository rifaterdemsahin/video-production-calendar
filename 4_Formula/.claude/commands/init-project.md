...
Sets up a new project from `video-production-calendar` by:
...
7. Making the first commit: `chore: initialize project from video-production-calendar`
...
```
git add .
git commit -m "chore: initialize <project-name> from video-production-calendar"
